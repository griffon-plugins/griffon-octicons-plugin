...
----
dependencies {
    griffon '{project-group}:griffon-octicons-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-octicons-swing:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-octicons-javafx:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-octicons-swing-groovy:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-octicons-javafx-groovy:{project-version}'
}
----

== Maven

First configure the `griffon-octicons-plugin` BOM in your POM file, by placing the following
